...
// TestBuildSlingFormulaVarsInjectsBaseBranchFromRigDefault covers the fork
// shape reported in ga-7mh5: the rig repo's live origin/HEAD points at a
...
// "main" default and every polecat worktree is cut from the branch the fork
// ROE forbids — silently, because a missing var is indistinguishable from an
// authored default at render time.
