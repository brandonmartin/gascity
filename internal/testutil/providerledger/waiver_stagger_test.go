...
// internal/runtime/t3bridge.NewSeamBacked before the legacy route was retired
// and the constructor proved — they deliberately share a date, because one
// contract closes both and splitting them would claim two pieces of work where
// there is one.
