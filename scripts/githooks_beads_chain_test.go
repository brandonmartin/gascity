...
// TestGitHooksCoverEveryBeadsManagedHook is the regression guard for ga-z1f5:
// beads took over core.hooksPath, and because .beads/hooks never chained onward
...
// TestCheckGitHooksOwnerRejectsForeignHooksPath is the detector for ga-z1f5:
// beads' installer repointing core.hooksPath at .beads/hooks must be reported,
// because the bypassed .githooks gate cannot report its own absence.
